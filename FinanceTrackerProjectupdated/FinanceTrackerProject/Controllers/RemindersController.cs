...
namespace FinanceTracker.Controllers
{
    public class RemindersController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            {
                DueDate = DateTime.Now // Set default value for DueDate
            };
        ...
        public ActionResult Create([Bind(Include = "ReminderId,DueDate,Amount,Description,IsPaid,UserId")] Reminder reminder)
        {
